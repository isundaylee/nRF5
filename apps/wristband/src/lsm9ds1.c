...
void lsm9ds1_init(lsm9ds1_t *dev, nrf_drv_twi_t const *twi) {
  ...
  lsm9ds1_write_byte(dev, LSM9DS1_ADDR_GYRO_ACCEL, 0x10, 0b01101000);
...
void lsm9ds1_accel_read_all(lsm9ds1_t *dev, int16_t *x, int16_t *y,
                            int16_t *z) {
  uint8_t data[6];
...
void lsm9ds1_gyro_read_all(lsm9ds1_t *dev, int16_t *x, int16_t *y, int16_t *z) {
  uint8_t data[6];
